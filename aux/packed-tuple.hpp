...
{
    template <class... Args>
    struct tuple_size<aux::packed_tuple<Args...>> {
        static constexpr auto value = sizeof... (Args);
    };
    template <class... Args>
    constexpr size_t tuple_size_v<aux::packed_tuple<Args...>> = sizeof... (Args);
    template <size_t I, class... Args>
    struct tuple_element<I, aux::packed_tuple<Args...>> {
        using type = decltype (std::declval<aux::packed_tuple<Args...>>().template get<I>());
    };
} // ::std
